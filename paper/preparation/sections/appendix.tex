...
\subsection*{Navigating scheduling}
...
In this experiments, we investigated the relationship between the navigation strength and the physical plausibility of the generated structures for both \AK (214 residues) and \flhac (346 residues).
...
This indicates the presence of a regime in which constraints can be applied without substantially degrading the geometric quality of the generated structures.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{images/figures-08.png}
    \caption{
