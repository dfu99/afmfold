...
We adopted a CNN that is invariant under the discrete version of the $\mathrm{SE}(2)$ group, namely $(\R^2, +) \rtimes C_8$. The specific implementation is described in \cref{alg:cnscnn}. 
