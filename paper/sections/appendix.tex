...
We defined navigating schedules $\hat{\eta}_{\hat{t}}$ from the sigmoidal family defined in \Cref{eq:sigmoid}.
Specifically, we vary two hyperparameters that determine \emph{when} navigating turns on ($\hat{t}_{\text{start}}$) and \emph{how strong} it becomes at the end ($y_{\text{max}}$).
