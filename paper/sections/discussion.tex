...
Notebooks, scripts, and datasets to reproduce the results of this paper are publicly available at Zenodo \cite{kawai_dataset_nodate}. HS-AFM data of \flhac are available upon reasonable request to the corresponding author and with the permission of the original authors \cite{inoue_structural_2019}. 
