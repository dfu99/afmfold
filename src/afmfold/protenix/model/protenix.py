...
from afmfold.protenix.model import sample_confidence
from afmfold.protenix.model.generator import (
    InferenceNoiseScheduler,
    TrainingNoiseSampler,
    sample_diffusion,
    sample_diffusion_training,
)
from afmfold.protenix.model.utils import simple_merge_dict_list
...
from afmfold.protenix.utils.permutation.permutation import SymmetricPermutation
from afmfold.protenix.utils.torch_utils import autocasting_disable_decorator
        ...
        _configs.update(
            {
                ...
                "guidance_kwargs": self.configs.guidance_kwargs
            }
        )
