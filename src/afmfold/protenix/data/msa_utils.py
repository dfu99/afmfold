...
from afmfold.protenix.data.constants import (
    PRO_STD_RESIDUES,
...
from afmfold.protenix.openfold_local.data import parsers
from afmfold.protenix.openfold_local.data.msa_identifiers import (
    Identifiers,
    _extract_sequence_identifier,
    _parse_sequence_identifier,
)
from afmfold.protenix.openfold_local.data.msa_pairing import (
    CHAIN_FEATURES,
    MSA_FEATURES,
    MSA_GAP_IDX,
    MSA_PAD_VALUES,
...
from afmfold.protenix.openfold_local.np import residue_constants
from afmfold.protenix.utils.distributed import DIST_WRAPPER

# FeatureDict, make_dummy_msa_obj, convert_monomer_features
# These are modified from openfold: data/data_pipeline
try:
    from afmfold.protenix.openfold_local.data.tools import jackhmmer
except ImportError:
    print(
