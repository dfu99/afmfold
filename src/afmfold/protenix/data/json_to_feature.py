...
from afmfold.protenix.data.json_parser import add_entity_atom_array, remove_leaving_atoms
from afmfold.protenix.data.parser import AddAtomArrayAnnot
from afmfold.protenix.data.tokenizer import AtomArrayTokenizer, TokenArray
from afmfold.protenix.data.utils import int_to_letters
