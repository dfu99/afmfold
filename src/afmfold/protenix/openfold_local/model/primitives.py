...
if fastln_is_installed:
    ...
    from afmfold.protenix.model.layer_norm.layer_norm import FusedLayerNorm
...
from afmfold.protenix.openfold_local.utils.precision_utils import is_fp16_enabled
from afmfold.protenix.openfold_local.utils.tensor_utils import (
    flatten_final_dims,
    permute_final_dims,
)
